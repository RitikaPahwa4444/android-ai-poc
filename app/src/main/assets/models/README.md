...
| Model | Size | SHA-256 |
|---|---:|---|
| `face_detection_yunet_2023mar.onnx` → `.ort` | 227 KB raw / 292 KB ORT | `8f2383e4dd3cfbb4553ea8718107fc0423210dc964f9f4280604804ed2552fa4` |
| `license_plate_detection_lpd_yunet_2023mar.onnx` → `.ort` | about 4.0 MB raw / 4.0 MB ORT | `6d4978a7b6d25514d5e24811b82bfb511d166bdd8ca3b03aa63c1623d4d039c7` |
| `license_plate_detection_lpd_yunet_2023mar_int8.onnx` → `.ort` | about 1.0 MB raw / 1.1 MB ORT | `d67982a014fe93ad04612f565ed23ca010dcb0fd925d880ef0edf9cd7bdf931a` |
...
The POC keeps only the Android/ONNX Runtime port needed for these models; it does not
...
The app loads the `.ort` assets generated from these source models. The full-precision model is the active plate detector. The int8 model is retained for
